    ...
    return (
        <ContainerWrapper className="pt-28  pb-20 bg-white grid md:grid-cols-2 gap-10">
            <div className="flex w-full flex-col justify-start items-start text-left gap-5">
                <h1 className="font-bold text-blue-950  text-2xl">FAQ'S</h1>
                <h1 className="font-extrabold text-6xl ">General <span className="text-blue-900">Frequently</span> Asked Questions</h1>
