...
function Services() {
    return (
        <ContainerWrapper className="pt-20 mt-16 pb-20 bg-blue-50" id="service">
            <div className="flex w-full flex-col justify-center items-center text-center gap-5">
                <h1 className="font-bold text-blue-950  text-2xl">ABOUT US</h1>
        ...
        <>
            <div className="shadow-xl shadow-gray-200  bg-white p-4  flex flex-col gap-3 pb-5 mt-32 transition-transform duration-500 transform hover:-translate-y-2">
                <div className="-mt-32 mb-3 relative" >
                    <img src={image} className="h-72 md:h-56 w-full rounded-3xl" />
                    <div className="w-20 h-20 right-4 -mt-12 bg-blue-950 flex justify-center items-center rounded-full absolute"><img src={logo} className="w-11 h-11" /></div>
                </div>
                <h1 className="font-bold text-2xl">{title}</h1>
                <p className=" text-gray-500 line-clamp-3 leading-7 ">{desc}</p>
                <a href={link || "#"} className="h-12  font-bold w-40 mt-5 gap-4 bg-blue-950 hover:bg-gray-950 transition-all flex justify-center  items-center text-white">Read More <FaArrowRightLong /></a>
            </div>
